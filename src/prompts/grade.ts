...
export function messages(
  ...
  const trainMessages: CoreMessage[] = [
    ...
    },
    {
      data: decrypt(
        fs.readFileSync(
          path.join(process.cwd(), "public/encripted/tomassi.pdf.enc"),
        ),
      ),
      response: {
        grade: "B",
    ...
    },
    {
      data: decrypt(
        fs.readFileSync(
          path.join(process.cwd(), "public/encripted/gimenez.pdf.enc"),
        ),
      ),
      response: {
        grade: "C",
    ...
    },
    {
      data: decrypt(
        fs.readFileSync(
          path.join(process.cwd(), "public/encripted/villalobos.pdf.enc"),
        ),
      ),
      response: {
        grade: "C",
    ...
    },
    {
      data: decrypt(
        fs.readFileSync(
          path.join(process.cwd(), "public/encripted/boga.pdf.enc"),
        ),
      ),
      response: {
        grade: "A",
    ...
    },
    {
      data: decrypt(
        fs.readFileSync(
          path.join(process.cwd(), "public/encripted/oviedo.pdf.enc"),
        ),
      ),
      response: {
        grade: "B",
    ...
    },
    {
      data: decrypt(
        fs.readFileSync(
          path.join(process.cwd(), "public/encripted/porracin.pdf.enc"),
        ),
      ),
      response: {
        grade: "B",
    ...
    },
    {
      data: decrypt(
        fs.readFileSync(
          path.join(process.cwd(), "public/encripted/montrull.pdf.enc"),
        ),
      ),
      response: {
        grade: "C",
    ...
    },
    {
      data: decrypt(
        fs.readFileSync(
          path.join(process.cwd(), "public/encripted/vega.pdf.enc"),
        ),
      ),
      response: {
        grade: "B",
